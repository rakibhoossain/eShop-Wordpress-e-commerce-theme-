<?php
/**
 * Class Eshop_Related_Posts_Output
 *
...
if ( ! function_exists( 'eshop_call_related_posts_class' ) ) {
	/**
	 *
	 ...
	 *
	 */
	function eshop_call_related_posts_class() {
		// instantiate the class & load everything else
		Eshop_Related_Posts::get_instance();
	}

	add_action( 'wp_loaded', 'eshop_call_related_posts_class' );
}


if ( ! class_exists( 'Eshop_Related_Posts' ) ) {

	/**
	 * Class Eshop_Related_Posts
	 */
	class Eshop_Related_Posts {
		...
		protected function __construct() {
			add_action( 'eshop_single_after_article', array( $this, 'output_related_posts' ), 2 );
		}
